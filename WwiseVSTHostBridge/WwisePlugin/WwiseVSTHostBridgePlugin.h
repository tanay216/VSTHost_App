...
class WwiseVSTHostBridgePlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    WwiseVSTHostBridgePlugin();
    ~WwiseVSTHostBridgePlugin();
...
DECLARE_AUDIOPLUGIN_CONTAINER(WwiseVSTHostBridge);	// Exposes our PluginContainer structure that contains the info for our plugin
