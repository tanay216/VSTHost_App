...
#ifndef WwiseVSTHostBridgeConfig_H
#define WwiseVSTHostBridgeConfig_H
...
namespace WwiseVSTHostBridgeConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 26463;
}

#endif // WwiseVSTHostBridgeConfig_H
