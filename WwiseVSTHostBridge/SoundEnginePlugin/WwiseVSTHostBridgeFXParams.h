...
#ifndef WwiseVSTHostBridgeFXParams_H
#define WwiseVSTHostBridgeFXParams_H
...
struct WwiseVSTHostBridgeRTPCParams
{
    AkReal32 fPlaceholder;
};

struct WwiseVSTHostBridgeNonRTPCParams
{
};

struct WwiseVSTHostBridgeFXParams
    : public AK::IAkPluginParam
{
    WwiseVSTHostBridgeFXParams();
    WwiseVSTHostBridgeFXParams(const WwiseVSTHostBridgeFXParams& in_rParams);
    ...
    WwiseVSTHostBridgeRTPCParams RTPC;
    WwiseVSTHostBridgeNonRTPCParams NonRTPC;
};

#endif // WwiseVSTHostBridgeFXParams_H
