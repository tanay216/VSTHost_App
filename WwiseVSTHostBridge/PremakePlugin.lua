...
local Plugin = {}
Plugin.name = "WwiseVSTHostBridge"
Plugin.factoryheader = "../SoundEnginePlugin/WwiseVSTHostBridgeFXFactory.h"
Plugin.appleteamid = ""
Plugin.sdk = {}
Plugin.sdk.static = {}
Plugin.sdk.shared = {}
...
{
    "WwiseVSTHostBridgeFXShared.cpp"
}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "WwiseVSTHostBridge.def",
    "WwiseVSTHostBridge.xml",
    "**.rc",
}
